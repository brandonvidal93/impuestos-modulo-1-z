...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      conectLMS: false,
      lastPage: false,
      unitFinal: [true, true, true, true],
      // unitFinal: [false, false, false, false],
      enableUnit: [true, true, true, true],
      // enableUnit: [true, false, false, false],
      // endActivities debe ir en FALSE para permitir las restricciones, en TRUE para editar
      // endActivities: [false, false, false, false, false, false, false, false, false, false, false, false, false, false]
