...
import {
  ...
  Page18, Page19 /* BackCover */ } from './pages/Pages';
  ...
  showContent = () => {
    ...
    switch (actualIndex) {
      ...
      case 1:
        // OBJETIVO
        return (
          <Page1 dataPage = { data.page1 } goToPage = { goToPage } />
        );
      case 2:
        // MENU
        return (
          <Page2 dataPage = { data.page2 } goToPage = { goToPage } menuPosition = { menuPosition } unitActual = { unitActual } updateActualUnit = { updateActualUnit } unitFinal = { unitFinal } enableUnit = { enableUnit } />
        );

      case 3:
        // PAGINA INICIO
        return (
          <Page3 dataPage = { data.page3 } goToPage = { goToPage } endActivities = { endActivities[1] } checkEndActivity = { checkEndActivity } />
        );
      case 4:
        return (
      ...
      case 10:
        // PAGINA FINAL
        return (
          <Page10 dataPage = { data.page10 } goToPage = { goToPage } endActivities = { endActivities[8] } checkEndActivity = { checkEndActivity } />
        );

      case 11:
        // PAGINA INICIO
        return (
          <Page11 dataPage = { data.page11 } goToPage = { goToPage } />
        );
      case 12:
        return (
          <Page12 dataPage = { data.page12 } goToPage = { goToPage } endActivities = { endActivities[9] } checkEndActivity = { checkEndActivity } />
        );
      case 13:
        return (
          <Page13 dataPage = { data.page13 } goToPage = { goToPage } endActivities = { endActivities[10] } checkEndActivity = { checkEndActivity } />
        );
      case 14:
        return (
          <Page14 dataPage = { data.page14 } goToPage = { goToPage } endActivities = { endActivities[11] } checkEndActivity = { checkEndActivity } />
        );
      case 15:
        // PAGINA FINAL
        return (
          <Page15 dataPage = { data.page15 } goToPage = { goToPage } />
        );

      case 16:
        // PAGINA INICIO
        return (
          <Page16 dataPage = { data.page16 } goToPage = { goToPage } />
        );
      case 17:
        return (
          <Page17 dataPage = { data.page17 } goToPage = { goToPage } endActivities = { endActivities[12] } checkEndActivity = { checkEndActivity } />
        );
      case 18:
        return (
          <Page18 dataPage = { data.page18 } goToPage = { goToPage } endActivities = { endActivities[13] } checkEndActivity = { checkEndActivity } />
        );
      case 19:
        // PAGINA FINAL
        return (
          <Page19 dataPage = { data.page19 } goToPage = { goToPage } endCourse = { showEndModal } />
        );
